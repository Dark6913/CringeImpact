...
public:
	...
	void loadAnimation(sf::Texture& texture, uint8_t frames_count, float frame_duration,
		sf::Vector2f scale = { 1.f, 1.f }, sf::Vector2f origin = {0.f, 0.f});
	void loadAnimation(std::string file, uint8_t frames_count, float frame_duration,
		sf::Vector2f scale = { 1.f, 1.f }, sf::Vector2f origin = { 0.f, 0.f });
